...
export const events = [
  {
    title: "Let Me Show You Something dev meetup",
    description:
      "A community meetup series for developers to share projects, ideas, and things they're building.",
    date: "Monthly",
...
export const moreEvents = [
  {
    title: "React Miami",
    description:
      "500 React developers gather in Miami sunshine to learn, connect, and explore the ecosystem.",
  ...
  },
  {
    ...
    description:
      "The premier AI engineering conference bringing 500+ engineers to Miami for connection and learning.",
    date: "April 20-21, 2026",
    location: "Downtown Miami, FL",
    link: "https://www.ai.engineer/miami",
    buttonText: "View Event",
  },
  {
    title: "Dev Writers Retreat",
    description:
      "A first-of-its-kind experiment pushing forward the state of coders-who-write and writers-who-code.",
...
export const communityItems = [
  {
    ...
    description:
      "A dynamic non-profit membership association strengthening the tech landscape of South Florida and Treasure Coast through talent and economic growth.",
...
export const workItems = [
  ...
  {
    title: "GitHub",
    description: "Check out the latest projects I've been working on.",
...
export const contactItems = [
  {
    ...
    emailUrl: "mailto:michelle.bakels@gmail.com",
    buttonText: "Send a Message",
    buttonLink: "mailto:michelle.bakels@gmail.com",
  },
  {
    title: "Follow Me",
    description:
    ...
    githubUrl: "https://github.com/michellebakels",
